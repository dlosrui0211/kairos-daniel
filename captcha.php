...
class CaptchaMath {
    ...
    public static function generarHTML() {
        ...
        <div class="captcha-container mb-3">
            <label for="captcha_respuesta" class="form-label fw-500">Captcha</label>
            <div>
            ...
            <input type="number" 
                   ...
                   required 
                   autocomplete="off">
            <div id="captchaHelp" class="form-text">Introduce el resultado de la operación matemática.</div>
        </div>';
